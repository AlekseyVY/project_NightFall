...
const getStory = async () => {
    await db.story.create({
        ...
        description: "The most beloved story by British author Beatrix Potter, published in 1902.",
        body: `ONCE upon a time there were four little Rabbits, and their names were— Flopsy, Mopsy, Cotton-tail, and Peter.
    ...
    await db.story.create({
        ...
        author: "T.S. Arthur",
        description: `An Angel in Disguise (1851) was featured in Arthur's collection, After a Shadow and Other Stories. "The sweetness of that sick child, looking ever to her in love, patience, and gratitude, was as honey to her soul, and she carried her in her heart as well as in her arms, a precious burden."`,
        body: `Idleness, vice, and intemperance had done their miserable work, and the dead mother lay cold and still amid her wretched children. She had fallen upon the threshold of her own door in a drunken fit, and died in the presence of her frightened little ones.
  ...
  `
    ...
    await db.story.create({
        ...
        description: `The Child's Story (1852) is a parable about life's journey, in which a traveller asks all he meets, "What do you do here?" and they invite him to join them, until it's time to move on.`,
        body: `Once upon a time, a good many years ago, there was a traveller, and he set out upon a journey. It was a magic journey, and was to seem very long when he began it, and very short when he got half way through.
    ...
    await db.story.create({
        ...
        author: "O. Henry",
        description: `The Child's Story (1852) is a parable about life's journey, in which a traveller asks all he meets, "What do you do here?" and they invite him to join them, until it's time to move on.`,
        body: `On his bench in Madison Square Soapy moved uneasily. When wild geese honk high of nights, and when women without sealskin coats grow kind to their husbands, and when Soapy moves uneasily on his bench in the park, you may know that winter is near at hand.
